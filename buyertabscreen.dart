...
class _BuyerTabScreenState extends State<BuyerTabScreen> {
                            ...
                            child: InkWell(
                              ...
                              child: Column(children: [
                                CachedNetworkImage(
                                  ...
                                  fit: BoxFit.cover,
                                  imageUrl:
                                      "${MyConfig().SERVER}/barterit/assets/catches/${catchList[index].catchId}.jpg",
  ...
  CachedNetworkImage({required double width, required BoxFit fit, required String imageUrl, required LinearProgressIndicator Function(dynamic context, dynamic url) placeholder, required Icon Function(dynamic context, dynamic url, dynamic error) errorWidget}) {}
}
